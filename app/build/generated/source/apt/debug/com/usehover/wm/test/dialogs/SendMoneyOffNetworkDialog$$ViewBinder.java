...
public class SendMoneyOffNetworkDialog$$ViewBinder<T extends SendMoneyOffNetworkDialog> implements ViewBinder<T> {
  @Override
  public Unbinder bind(Finder finder, T target, Object source) {
    return new InnerUnbinder<>(target, finder, source);
  }

  protected static class InnerUnbinder<T extends SendMoneyOffNetworkDialog> implements Unbinder {
    protected T target;
    ...
    protected InnerUnbinder(final T target, Finder finder, Object source) {
      ...
      target.etNrcNumber = finder.findRequiredViewAsType(source, 2131558506, "field 'etNrcNumber'", EditText.class);
      target.etAmountToSend = finder.findRequiredViewAsType(source, 2131558508, "field 'etAmountToSend'", EditText.class);
      target.etWithdrawlCode = finder.findRequiredViewAsType(source, 2131558510, "field 'etWithdrawlCode'", EditText.class);
    ...
    public void unbind() {
      ...
      target.etNrcNumber = null;
      target.etAmountToSend = null;
      target.etWithdrawlCode = null;
